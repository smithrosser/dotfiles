...
-- Color scheming
config.color_scheme = color_schemes:get_scheme(wezterm.gui.get_appearance())

-- Fonts
local selected_font = fonts.families[fonts.selected_font]
config.font_size = fonts.size
config.font = wezterm.font_with_fallback({
    fonts:get_font(fonts.families[fonts.selected_font]),
    fonts:get_font(fonts.families[fonts.fallback_font]),
})
